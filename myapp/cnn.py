...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'C:\Users\Fatema Hana\OneDrive\Desktop\Project\dataseteye')
    for pa in my_list:

        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\Fatema Hana\OneDrive\Desktop\Project\dataseteye\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\Fatema Hana\OneDrive\Desktop\Project\dataseteye\\'+pa, f)
